...
public class DownloadTableProgressRenderer extends DefaultTableCellRenderer {
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
		...
		String file = null;
		if (savedPath != null) file = savedPath.toFile().getName();
		else file = dlListPanel.getSourceAtIndex(row);
		String text = null;
		String state = DownloadState.COMPLETE.toString();
		if (i == NewDownloader.PUBLISH_ERROR) {
			state = DownloadState.ERROR.toString();
		} else if (i == NewDownloader.PUBLISH_CANCEL) {
