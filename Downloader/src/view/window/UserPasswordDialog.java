...
public class UserPasswordDialog extends JDialog {
	...
	private class UserPasswordActionListener implements ActionListener {
		...
		private void doOK() {
			...
			if ("".equals(username)) {
				JOptionPane.showMessageDialog(dialog, "Username cannot be null", "Null input for username", JOptionPane.WARNING_MESSAGE);
			} else if ("".equals(password)) {
				JOptionPane.showMessageDialog(dialog, "Password cannot be null", "Null input for password", JOptionPane.WARNING_MESSAGE);
			} else {
